...
public interface CustomerReviewDao {
    ...
    //public void load(CustomerReview review) throws DataAccessException;
    public void save(CustomerReview review) throws DataAccessException;
    
    // TODO:
    //public List findByCustomerId(int customerId) throws DataAccessException;
    //public List findByBookId(int bookId) throws DataAccessException;
